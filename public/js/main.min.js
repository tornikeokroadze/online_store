    ...
    var e, i, n, o, s, a, r, l, c = {
        ...
        lightBox: function() {
            ...
            e = t(".product-slider-container").length > 0 ? t(".product-single-carousel .owl-item:not(.cloned) img") : t(".product-single-gallery img"), t(".media-with-zoom").length > 0 && (e = t(".media-with-zoom .owl-carousel .owl-item:not(.cloned) img")), t(".team-section").length > 0 && (e = t(".team-section img")), e.each((function() {
                ...
                e.preventDefault();
                var i = t(this);
                i.closest(".product-default").find("figure").hasClass("load-more-overlay") || (i.closest(".product-default").find("figure").addClass("load-more-overlay"), i.closest(".product-default").find("figure").append('<i class="atsarmoe-loading-icon"></i>'));
                    ...
                    t.magnificPopup.open({
                        ...
                        callbacks: {
                            ...
                            ajaxContentAdded: function() {
                                c.ajaxLoading(), i.closest(".product-default").find("figure").removeClass("load-more-overlay"), i.closest(".product-default").find("figure .atsarmoe-loading-icon").remove(), c.quantityInputs(t(".mfp-ajax-product")), c.initProductSinglePage(), c.owlCarousels()
                            },
